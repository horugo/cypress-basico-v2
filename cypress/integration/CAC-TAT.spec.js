...
describe("Central de Atendimento ao Cliente TAT", function () {
  ...
  it("preeche os campos obrigatorios e envia o formulario", function () {
    const longText =
      "teste, teste, teste, teste, testeteste, teste, teste, teste, testeteste, teste, teste, teste, testeteste, teste, teste, teste, testeteste, teste, teste, teste, teste";
  ...
  Cypress._.times(3, function () {
    it("campo telefone continua vazio quando preenchido com valor não-numerico", function () {
      cy.get("#phone").type("abcdefgij").should("have.value", "");
    });
  });
  ...
  it("preenche e limpa os campos nome, sobrenome, email e telefone", function () {
    ...
    cy.get("#lastName")
      ...
      .should("have.value", "");
    cy.get("#email")
      .type("victorhpdantas@gmail.com")
      .should("have.value", "victorhpdantas@gmail.com")
      .clear()
      .should("have.value", "");
  ...
  it("encontra o gato escondido", function () {
    ...
    cy.get("#subtitle").invoke("text", "Eu prefiro cachoros");
  });
});
